...
PRESETS: list[dict] = [
    ...
    {
        "preset_key": "polizza_scaduta_giorno",
        "nome": "Polizza scaduta — giorno stesso (T+0)",
        "descrizione": "Avviso al cliente e al collaboratore il giorno in cui la polizza scade.",
        "tipo": "schedule", "schedule_kind": "polizza_scaduta_giorno",
        "cron": "0 8 * * *",
        "soglia_giorni": 0,
        "canali": ["inapp", "email"], "destinatari": ["cliente", "collaboratore"],
        "template_oggetto": "La sua polizza {numero_polizza} scade oggi",
        "template_corpo": "Gentile {cliente_nome}, la polizza {numero_polizza} scade in data odierna {scadenza}. La preghiamo di contattarci per il rinnovo.",
    },
    {
        "preset_key": "polizza_scaduta_5g",
        "nome": "Polizza scaduta da 5 giorni",
        "descrizione": "Avviso 5 giorni dopo la scadenza polizza non rinnovata.",
        "tipo": "schedule", "schedule_kind": "polizza_scaduta_5g",
        "cron": "0 9 * * *", "soglia_giorni": 5,
        "canali": ["inapp", "email", "whatsapp"], "destinatari": ["cliente", "collaboratore"],
        "template_oggetto": "Polizza {numero_polizza} scaduta da 5 giorni",
        "template_corpo": "Gentile {cliente_nome}, la polizza {numero_polizza} risulta scaduta dal {scadenza}. È importante regolarizzarla.",
    },
    {
        "preset_key": "polizza_scaduta_10g",
        "nome": "Polizza scaduta da 10 giorni",
        "descrizione": "Sollecito 10 giorni dopo la scadenza polizza non rinnovata.",
        "tipo": "schedule", "schedule_kind": "polizza_scaduta_10g",
        "cron": "0 9 * * *", "soglia_giorni": 10,
        "canali": ["inapp", "email", "whatsapp"], "destinatari": ["cliente", "collaboratore"],
        "template_oggetto": "Sollecito: polizza {numero_polizza} scaduta da 10 giorni",
        "template_corpo": "Gentile {cliente_nome}, la polizza {numero_polizza} è scaduta dal {scadenza}. Si trova in periodo di tolleranza/copertura limitata.",
    },
    {
        "preset_key": "polizza_scaduta_14g",
        "nome": "Polizza scaduta da 14 giorni",
        "descrizione": "Sollecito 14 giorni dopo la scadenza polizza non rinnovata.",
        "tipo": "schedule", "schedule_kind": "polizza_scaduta_14g",
        "cron": "0 9 * * *", "soglia_giorni": 14,
        "canali": ["inapp", "email", "whatsapp"], "destinatari": ["cliente", "collaboratore", "admin"],
        "template_oggetto": "Ultimo avviso: polizza {numero_polizza} scaduta da 14 giorni",
        "template_corpo": "Gentile {cliente_nome}, la polizza {numero_polizza} è scaduta dal {scadenza}. Senza il rinnovo immediato perderà la copertura.",
    },
    {
        "preset_key": "polizza_scaduta_15g",
        "nome": "Polizza scaduta da 15 giorni — chiusura copertura",
        "descrizione": "Avviso finale e chiusura copertura a 15 giorni.",
        "tipo": "schedule", "schedule_kind": "polizza_scaduta_15g",
        "cron": "0 9 * * *", "soglia_giorni": 15,
        "canali": ["inapp", "email", "whatsapp"], "destinatari": ["cliente", "collaboratore", "admin"],
        "template_oggetto": "Polizza {numero_polizza} scaduta da 15 giorni — copertura cessata",
        "template_corpo": "Gentile {cliente_nome}, la polizza {numero_polizza} risulta scaduta dal {scadenza} ed è ora priva di copertura.",
    },
]
