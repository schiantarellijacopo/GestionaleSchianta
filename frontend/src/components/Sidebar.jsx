...
const ALL_MENU_ITEMS = [
    ...
    { id: "marketing", path: "/marketing", icon: "Megaphone", label: "Marketing", section: "marketing", roles: ["admin", "collaboratore", "dipendente"] },
    ...
    { id: "lead_liste", path: "/lead-liste", icon: "ListChecks", label: "Liste Lead", section: "marketing", roles: ["admin", "collaboratore", "dipendente"] },
